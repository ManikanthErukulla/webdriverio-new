...
let baseUrl = 'https://www.nationwide.co.uk/';
...
exports.config = {
    ...
    capabilities: [
        ...
        // // ,
        {
            ...
            browserName: 'chrome',
            'goog:chromeOptions': {
                args: ['--no-headless','--no-sandbox','--disable-gpu','--disable-dev-shm-usage','--window-size=1920,1080']
            }
        }
        ],
    //
    ...
    // reporterOptions: {
    //     htmlFormat: {outputDir: './reports/html-reports/'},
    //     useOnAfterCommandForScreenshot:true,
    // },
